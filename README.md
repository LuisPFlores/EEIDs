...
Comprehensive guide and automation scripts for implementing **Microsoft Entra External Identities** (CIAM - Customer Identity and Access Management) scenarios.
...
### 3️⃣ Test Auth — OAuth 2.0 / OpenID Connect (`webapp/`)
...
### 4️⃣ Test Auth — WS-Federation (`webapp-wsfed/`)
...
### 5️⃣ Test Auth - SAML 2.0 (`webapp-saml/`)
...
# Verify installation
Get-Module -ListAvailable Microsoft.Graph, AzureADPreview
```
